    ...
    export class AuthController {
        ...
        private getCookieOptions(req: Request) {
            ...
            // ✅ Kondisi 1: Development (localhost)
            // Untuk semua request dari localhost, gunakan opsi ini.
            // sameSite: 'none' diperlukan untuk cross-port (localhost:3001 -> localhost:3000).
            // secure: false karena backend berjalan di HTTP.
            if (isLocalhost) {
                return {
                    httpOnly: true,
                    secure: false,
            ...
            // ✅ Kondisi 2: Production
            // Untuk semua request selain localhost, gunakan opsi produksi.
            return {
                httpOnly: true,
                secure: true,
                sameSite: 'lax' as const,
